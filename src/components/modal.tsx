export default function Modal({accuracy,wpm}){
    ...
    return <div className="flex flex-col h-4/6 w-4/12 border border-blue-500 rounded-md left-1/2 top-1/2 backdrop-blur-3xl transform -translate-x-1/2 -translate-y-1/2 justify-around items-center p-1 shadow-2xl absolute   bg-white bg-opacity-80">
